...
use astrape_sdk::{AgentOverrideConfig, AgentOverrides};
...
fn tier_builder_prefers_dedicated_prompt_file_when_present() {
    ...
    let base = astrape_sdk::AgentConfig {
...
fn tool_restrictions_registry_inherits_for_tier_variants() {
    ...
    let mut cfg = astrape_sdk::AgentConfig {
...
fn registry_factory_produces_cloned_configs() {
    ...
    reg.register_config(astrape_sdk::AgentConfig {
        name: "a".to_string(),
