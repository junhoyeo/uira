...
fn select_agent_type(component: &Component) -> String {
    match component.role {
        ComponentRole::Frontend | ComponentRole::Ui => "uira:designer".to_string(),
        ComponentRole::Backend
        | ComponentRole::Database
        | ComponentRole::Api
        | ComponentRole::Shared
        | ComponentRole::Config
        | ComponentRole::Module => "uira:executor".to_string(),
        ComponentRole::Coordinator => "uira:architect".to_string(),
        ComponentRole::Testing => "uira:qa-tester".to_string(),
        ComponentRole::Docs => "uira:writer".to_string(),
    }
}
