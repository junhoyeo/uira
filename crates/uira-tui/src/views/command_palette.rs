...
impl CommandPalette {
    ...
    fn default_commands() -> Vec<PaletteCommand> {
        vec![
            ...
            PaletteCommand {
                id: "mark_todo_done".into(),
                title: "Mark Selected Todo Done".into(),
                category: "Tools".into(),
                keybind: None,
                slash: None,
            },
            PaletteCommand {
                id: "toggle_context".into(),
                title: "Toggle Context Section".into(),
                category: "Tools".into(),
                keybind: None,
                slash: None,
            },
            PaletteCommand {
                id: "toggle_mcp".into(),
                title: "Toggle MCP Section".into(),
                category: "Tools".into(),
                keybind: None,
                slash: None,
            },
            PaletteCommand {
                id: "toggle_todos".into(),
                title: "Toggle Todos Section".into(),
                category: "Tools".into(),
                keybind: None,
                slash: None,
            },
            PaletteCommand {
                id: "toggle_files".into(),
                title: "Toggle Files Section".into(),
                category: "Tools".into(),
                keybind: None,
                slash: None,
            },
